...
query = ["cat", "dog"]
binary = [0, 1, 1]
doc1Score = binary[0] * tf_idf(d1List, "love", 10) + binary[1] * tf_idf(d1List, "cat", 10) + binary[2] * tf_idf(d1List, "dog", 10)
doc2Score = binary[0] * tf_idf(d2List, "love", 10) + binary[1] * tf_idf(d2List, "cat", 10) + binary[2] * tf_idf(d2List, "dog", 10)
doc3Score = binary[0] * tf_idf(d3List, "love", 10) + binary[1] * tf_idf(d3List, "cat", 10) + binary[2] * tf_idf(d3List, "dog", 10)
print("Document 1 Score is: " + str(doc1Score) + "\nDocument 2 Score is: " + str(doc2Score) + "\nDocument 3 Score is: " + str(doc3Score) + "\nDocument 1 and 3 have a score above 0.1 so")


# Calculate and print the precision and recall of the model by considering that the search engine will return all documents with scores >= 0.1.
print("Documents 1 and 3 will be returned and are relevant. So there are 2 hits and 0 misses and 0 noise\nPrecision = 2/2+0 = " + str((2/2) * 100) + "\nRecall = 2/2+0 = " + str((2/2) * 100))
